...
RUN apt-get update && apt-get install -y wget && wget https://download.blender.org/release/Blender$BLENDER_SHORT_VERSION/blender-$BLENDER_FULL_VERSION-linux64.tar.xz && tar -xf blender-$BLENDER_FULL_VERSION-linux64.tar.xz && rm blender>
